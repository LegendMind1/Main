...
//=================== Start of Get Appointment Details API ================
  ...
  if (!isLoading) {
              ...
              try{
                ...
                //alert ('I am triggered and stored symptoms to ' + vSymptoms)
                }
                //console.log(doctors);
  ...
  let values = {
    ...
    txtSymptoms : document.getElementById('txtSymptoms').value, 
    txtDiag : document.getElementById('txtDiag').value, 
    txtDocComments : document.getElementById('txtDocComments').value, 
    txtPresc : document.getElementById('txtPresc').value, 
  }
     //====================== Update Details API=========================
          ...
          <section className='flex justify-center'>
            <div className='w-[90%] max-md:w-4/5 mb-10 bg-cyan-800 rounded-3xl text-white h-auto justify-center items-center flex pt-10 pr-10 pl-10 pb-2'>
                ...
                <div className='w-full mt-6'>
                    ...
                    <div className='mt-6'>
                        <button type='submit' className='invisible bg-green-700 inline-block px-6 py-2.5 text-green-300 font-medium text-xs leading-tight uppercase rounded shadow-md hover:bg-green-700 hover:text-white hover:shadow-lg focus:shadow-lg focus:outline-none focus:ring-0 active:shadow-lg transition duration-150 ease-in-out w-full'>
